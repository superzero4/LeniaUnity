...
namespace Pcx
{
    ...
    public sealed class PointCloudRenderer : MonoBehaviour
    {
        ...
        [SerializeField, Range(0, 1f)] float _pointSize = 0.05f;
        [SerializeField] private bool _refreshMat = false;
        ...
        void OnRenderObject()
        {
            ...
            if (_texture == null && sourceBuffer == null) return;
            ...
            if (pointBuffer == null)
                pointBuffer =
                    sourceBuffer != null ? sourceBuffer : new ComputeBuffer(pix.Length, sizeof(float) * 4);
            pointBuffer.SetData(pix);
            if (_pointSize == 0)
            {
                ...
                _pointMaterial.SetTexture("_MainTex", _texture);
